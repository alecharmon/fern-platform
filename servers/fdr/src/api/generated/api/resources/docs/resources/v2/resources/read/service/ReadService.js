...
export class ReadService {
    ...
    toRouter() {
        ...
        this.router.post("/ensure-docs-in-s3", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.ensureDocsInS3(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(responseBody);
                    }),
                    cookie: res.cookie.bind(res),
                ...
                if (error instanceof errors.FernRegistryError) {
                    switch (error.errorName) {
                        ...
                        case "UnauthorizedError":
                            break;
                        default:
                            console.warn(`Endpoint 'ensureDocsInS3' unexpectedly threw ${error.constructor.name}.` +
                                ` If this was intentional, please add ${error.constructor.name} to` +
                                " the endpoint's errors list in your Fern Definition.");
                    }
                    yield error.send(res);
