...
export const DocsTypographyConfigSchema = z.object({
    headingsFont: z.object({ name: z.string(), fontFile: FileIdSchema }).nullish(),
    bodyFont: z.object({ name: z.string(), fontFile: FileIdSchema }).nullish(),
    codeFont: z.object({ name: z.string(), fontFile: FileIdSchema }).nullish()
});
