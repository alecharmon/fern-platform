...
export interface DatabaseService {
    ...
    getApiLatestDefinition(id: string): Promise<FdrAPI.api.latest.ApiDefinition | null>;
...
export class DatabaseServiceImpl implements DatabaseService {
    ...
    public async getApiLatestDefinition(id: string) {
        ...
        try {
            return JSON.parse(record.definition.toString()) as FdrAPI.api.latest.ApiDefinition;
        } catch {
            return null;
        }
    }
