...
export interface IndexSegmentDao {
    loadIndexSegment(indexSegmentId: string): Promise<LoadIndexSegmentResponse | undefined>;
}

export class IndexSegmentDaoImpl implements IndexSegmentDao {
    constructor(private readonly prisma: PrismaClient) {}

    public async loadIndexSegment(indexSegmentId: string): Promise<LoadIndexSegmentResponse | undefined> {
