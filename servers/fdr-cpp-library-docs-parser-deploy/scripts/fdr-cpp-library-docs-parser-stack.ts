...
export class FdrCppLibraryDocsParserStack extends Stack {
    constructor(
        scope: Construct,
        id: string,
        version: string,
        ...
        const lambdaName = "fdr-cpp-library-docs-parser";
        ...
        const lambdaFunction = new lambda.DockerImageFunction(this, `${lambdaName}-lambda-function`, {
            functionName,
            code: lambda.DockerImageCode.fromImageAsset(path.join(__dirname, "../../fdr-cpp-library-docs-parser")),
