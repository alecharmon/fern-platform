...
import { FdrPythonLibraryDocsParserStack } from "../scripts/fdr-python-library-docs-parser-stack";
    ...
    for (const [environmentType, environmentInfo] of Object.entries(environments)) {
        ...
        switch (environmentType) {
            ...
            case EnvironmentType.Prod:
                new FdrPythonLibraryDocsParserStack(
                    app,
                    `fdr-python-library-docs-parser-${environmentType.toLowerCase()}`,
                    version,
                    environmentType,
                    environmentInfo,
                    {
