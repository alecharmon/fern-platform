...
class FAIChatHTTPIntegration:
    """Integration that calls FAI-Chat HTTP /chat endpoint."""
    ...
    def __init__(
        ...
        faichat_url: str | None = None,
        ssl_verify: bool | None = None,
    ):
        self.domain = domain
        self.model = model
        self.system_prompt = system_prompt
        self.faichat_url = faichat_url or os.environ.get("FAICHAT_URL", "https://fai-chat.buildwithfern.com")

        if ssl_verify is None:
            self.ssl_verify = "buildwithfern.com" in self.faichat_url
        else:
        ...
        for attempt in range(max_retries):
            ...
            try:
                ...
                if assistant_query_id:
                    metadata["faichat_query_id"] = assistant_query_id

                if tool_call_count > 0:
                    metadata["faichat_tool_calls"] = tool_call_count
