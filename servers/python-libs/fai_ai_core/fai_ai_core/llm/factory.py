...
def _create_llm_provider(
    ...
    fallback_callback: Callable[[str, str, str | None], None] | None = None,
) -> LLMProvider:
    ...
    return FallbackProvider(providers, on_fallback=fallback_callback)
...
def get_llm_provider(
    ...
    try:
        return _get_llm_provider_cached(
            ...
            temperature=temperature,
            max_tokens=max_tokens,
            provider_preference_tuple=provider_preference_tuple,
            fallback_callback=fallback_callback,
        )
    except TypeError:
        provider_list: list[Literal["bedrock", "anthropic", "cohere"]] = [*provider_preference_tuple]
