...
export declare namespace CliClient {
...
export class CliClient {
    protected readonly _options: CliClient.Options;

    constructor(options: CliClient.Options = {}) {
     ...
     * @param {CliClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getLatestCliRelease(
        ...
        requestOptions?: CliClient.RequestOptions,
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.FernRegistryEnvironment.Prod,
                `/generators/cli/for-ir/${core.url.encodePathParam(irVersion)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.FernRegistryEnvironment.Prod,
                `/generators/cli/${core.url.encodePathParam(cliVersion)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
