...
export declare namespace LatestClient {
    export interface Options extends BaseClientOptions {}

    export interface RequestOptions extends BaseRequestOptions {}
}

export class LatestClient {
    protected readonly _options: LatestClient.Options;

    constructor(options: LatestClient.Options = {}) {
    ...
    public getApiLatest(
        ...
        requestOptions?: LatestClient.RequestOptions,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/registry/api/latest/load/${core.url.encodePathParam(apiDefinitionId)}`,
            ),
            method: "GET",
            headers: _headers,
