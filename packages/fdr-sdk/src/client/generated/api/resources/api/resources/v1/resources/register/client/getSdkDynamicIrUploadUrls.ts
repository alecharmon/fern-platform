...
export const Error = {
    ...
    _visit: <_Result>(
        value: FernRegistry.api.v1.register.getSdkDynamicIrUploadUrls.Error,
        visitor: FernRegistry.api.v1.register.getSdkDynamicIrUploadUrls.Error._Visitor<_Result>,
    ): _Result => {
        switch (value.error) {
