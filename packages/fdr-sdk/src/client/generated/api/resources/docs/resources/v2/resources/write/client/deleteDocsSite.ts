...
export const Error = {
    docsNotFoundError: (): FernRegistry.docs.v2.write.deleteDocsSite.Error.DocsNotFoundError => {
        return {
            error: "DocsNotFoundError",
        };
    },

    unauthorizedError: (value: string): FernRegistry.docs.v2.write.deleteDocsSite.Error.UnauthorizedError => {
        return {
            content: value,
            error: "UnauthorizedError",
        };
    ...
    _visit: <_Result>(
        value: FernRegistry.docs.v2.write.deleteDocsSite.Error,
        visitor: FernRegistry.docs.v2.write.deleteDocsSite.Error._Visitor<_Result>,
    ): _Result => {
        switch (value.error) {
