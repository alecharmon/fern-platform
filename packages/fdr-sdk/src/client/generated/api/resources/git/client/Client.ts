...
export declare namespace GitClient {
...
export class GitClient {
    protected readonly _options: GitClient.Options;

    constructor(options: GitClient.Options = {}) {
     ...
     * @param {GitClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public getRepository(
        ...
        requestOptions?: GitClient.RequestOptions,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/generators/github/repository/${core.url.encodePathParam(repositoryOwner)}/${core.url.encodePathParam(repositoryName)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.FernRegistryEnvironment.Prod,
                `/generators/github/repository/${core.url.encodePathParam(repositoryOwner)}/${core.url.encodePathParam(repositoryName)}/delete`,
            ),
            method: "DELETE",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.FernRegistryEnvironment.Prod,
                `/generators/github/pull-request/${core.url.encodePathParam(repositoryOwner)}/${core.url.encodePathParam(repositoryName)}/${core.url.encodePathParam(pullRequestNumber)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.FernRegistryEnvironment.Prod,
                `/generators/github/pull-request/${core.url.encodePathParam(repositoryOwner)}/${core.url.encodePathParam(repositoryName)}/${core.url.encodePathParam(pullRequestNumber)}/delete`,
            ),
            method: "DELETE",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
