...
/**
 * Standard build function for Fern packages
 * @param {string} dirname - The __dirname of the calling build.mjs file
 * @param {Object} options - Build options
 * @param {string} [options.entry='src/index.ts'] - Entry point for tsup
 ...
 */
export async function buildPackage(dirname, options = {}) {
    const { entry = "src/index.ts", tsupOptions = {}, copy = null } = options;
...
/**
 * Standard build function for Fern generators (CLI tools)
 * @param {string} dirname - The __dirname of the calling build.mjs file
 * @param {Object} options - Build options
...
export async function buildGenerator(dirname, options = {}) {
    ...
    // Generators typically only need CJS format
    const defaultTsupOptions = {
        entry: [entry],
        format: ["cjs"],
        sourcemap: true,
