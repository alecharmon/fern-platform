...
export function TypeDefinitionAnchor({ children, sideOffset, FernAnchor }: TypeDefinitionAnchorProps) {
    const href = useHref();
    return (
...
export function PropertyContainer({ children, ...props }: PropertyContainerProps & React.ComponentProps<"div">) {
