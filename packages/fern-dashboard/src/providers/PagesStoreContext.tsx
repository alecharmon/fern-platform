...
export function PagesStoreProvider({ children, branchName }: PagesStoreProviderProps) {
    ...
    return <PagesStoreContext.Provider value={{ pagesStore: storeRef.current }}>{children}</PagesStoreContext.Provider>;
}
