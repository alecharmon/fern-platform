...
describe("PagesStore", () => {
    ...
    describe("MDX file management", () => {
        it("should track and generate MDX content", () => {
            ...
            store.initializePage("test2.mdx", undefined, "<p>Initial</p>", { title: "Test" }, undefined);
    ...
    describe("page initialization", () => {
        it("should initialize and load persisted pages", () => {
            store.initializePage("test.mdx", undefined, "<p>Test</p>", { title: "Test Page" }, undefined);
    ...
    describe("persistence", () => {
        it("should persist changes to NavigationStore", () => {
            store.initializePage("test.mdx", undefined, "<p>Initial</p>", { title: "Test" }, undefined);
    ...
    describe("Real NavigationStore Integration", () => {
        ...
        it("should handle create/update/delete page sequence", () => {
            ...
            const pages = ["A", "B", "C"].map((letter) => {
                ...
                const pageNode = createTestNode(`page-${letter.toLowerCase()}`, `Page ${letter}`);

                pagesStore.createPage(parentId, pageNode, mockSidebar, pageData, `page-${letter.toLowerCase()}`);
