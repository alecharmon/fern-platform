...
import { UnsupportedContentInline } from "../UnsupportedContent";

export const InlineCustomElementNodeView = (props: NodeViewProps) => {
    ...
    return (
        <ErrorBoundary
            fallback={
                <NodeViewWrapper as="span" className="inline-flex w-auto align-middle">
                    <UnsupportedContentInline />
                </NodeViewWrapper>
            }
        >
            <NodeViewWrapper as="span" className="inline-flex w-auto align-middle">
