...
export class IntegerInputControl extends Control {
    ...
    getDefaultValue(): AttributeValue {
        return {
            type: "value",
            rawStringValue: this.defaultValue !== undefined ? String(this.defaultValue) : ""
        };
    }
}
...
export type AttributeConfig<T extends Record<string, Control> = Record<string, Control>> = T;
