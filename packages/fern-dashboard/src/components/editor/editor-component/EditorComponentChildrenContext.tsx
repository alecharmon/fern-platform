...
const EditorComponentChildrenContext =
  createContext<EditorComponentChildrenContextValue>({
...
> = ({ appendChildrenMdx, providedChildren, children }) => {
  ...
  return (
    <EditorComponentChildrenContext.Provider value={value}>
      {children}
    </EditorComponentChildrenContext.Provider>
  );
};

export const useEditorComponentChildren =
  (): EditorComponentChildrenContextValue => {
