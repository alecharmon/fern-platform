...
function runPlayground() {
  ...
  try {
    ...
    console.log(
      `  Custom Elements: ${customAnalysis.customElements} (vs ${analysis.customElements} default)`
    );
    console.log();
    ...
    console.log(
      `  Found node types: ${Array.from(nodeTypes).sort().join(", ")}`
    );
...
function interactiveMode() {
  ...
  console.log("\n🔄 Interactive Mode");
  console.log(
    "Enter your MDX content (type 'exit' to quit, 'sample' for sample content):"
  );
