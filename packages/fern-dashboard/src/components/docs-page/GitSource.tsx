 ...
 */
export async function GitSource({ docsUrl }: { docsUrl: DocsUrl }) {
    ...
    return <GitSourceClient docsUrl={docsUrl} gitUrl={gitUrlResult.success ? gitUrlResult.gitUrl : undefined} />;
}
