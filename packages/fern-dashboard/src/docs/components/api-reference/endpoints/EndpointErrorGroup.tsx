...
/**
 * Dashboard-specific EndpointErrorGroup (client-side MDX).
 *
 * Wraps EndpointErrorGroupClient with dashboard's EndpointError component.
 *
 * @see packages/fern-docs/bundle/src/components/api-reference/endpoints/EndpointErrorGroup.tsx
 */
