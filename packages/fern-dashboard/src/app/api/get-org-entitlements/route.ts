...
export declare namespace getOrgEntitlements {
    export type Request = z.infer<typeof GetOrgEntitlementsRequest>;
    export type Response = ResolvedReturnType<typeof handler>;
}

export const GetOrgEntitlementsRequest = z.object({
...
export async function POST(req: NextRequest) {
    ...
    const parsedBody = await parseNextRequestBody(req, GetOrgEntitlementsRequest);
