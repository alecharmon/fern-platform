...
interface CreateOrganizationModalInlineProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    onOrgCreated: (orgName: string) => void;
}

export function CreateOrganizationModalInline({
    open,
    onOpenChange,
    onOrgCreated
}: CreateOrganizationModalInlineProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setIsLoading(false);
            // Notify parent with the new organization name
            onOrgCreated(data.organizationId);
        } catch (err) {
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="mx-auto w-[calc(100%-2rem)] sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>Setup a new organization to manage your documentation.</DialogDescription>
                </DialogHeader>
