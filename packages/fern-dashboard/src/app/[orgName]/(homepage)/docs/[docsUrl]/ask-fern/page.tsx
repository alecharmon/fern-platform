...
export default async function Page(props: { params: Promise<{ orgName: Auth0OrgName; docsUrl: string }> }) {
    ...
    return (
        <AskAiEnabledServerSide docsUrl={params.docsUrl} orgName={params.orgName} redirectWhenDisabled={true}>
            <AnalyticsPage docsUrl={params.docsUrl} analyticsBillingEnabled={analyticsBillingEnabled ?? false} />
