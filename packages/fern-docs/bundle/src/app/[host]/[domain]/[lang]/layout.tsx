...
export default async function Layout({ children, params }: { children: React.ReactNode; params: Promise<BaseParams> }) {
...
export async function generateMetadata(props: { params: Promise<BaseParams> }): Promise<Metadata> {
