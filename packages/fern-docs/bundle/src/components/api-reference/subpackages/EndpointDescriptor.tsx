...
import { HttpMethodIcon } from "@fern-docs/components/HttpMethodIcon";
import { MonospaceText } from "@fern-docs/components/MonospaceText";
    ...
    return (
        <button className="group flex items-start justify-start space-x-2" onClick={onClick}>
            <div className="flex items-baseline space-x-2">
                <HttpMethodIcon />
                <MonospaceText className="text-(color:--grayscale-a11) w-16 break-all text-end text-sm leading-5 transition-colors group-hover:text-white">
                    {endpointDefinition.method}
                </MonospaceText>
            </div>

            <div className="flex">
                <MonospaceText className="text-(color:--grayscale-a11) break-words text-start text-sm leading-5 transition-colors group-hover:text-white">
                    {urlWithBreakpoints}
                </MonospaceText>
            </div>
        </button>
