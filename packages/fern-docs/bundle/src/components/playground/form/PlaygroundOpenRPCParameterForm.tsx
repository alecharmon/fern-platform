...
export const PlaygroundOpenRPCParameterForm = withErrorBoundary(PlaygroundOpenRPCParameterFormInternal);
    ...
    const onChangeOpenRPCParameter = useCallback(
        (index: number, newValue: unknown) => {
            onChange((oldValue: unknown) => {
                ...
                newArray[index] = typeof newValue === "function" ? newValue(newArray[index]) : newValue;
                return newArray;
            });
        },
        [onChange]
