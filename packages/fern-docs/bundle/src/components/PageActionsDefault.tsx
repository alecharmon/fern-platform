...
export function PageActionsDefault({
    ...
    const handleDefaultAction = async () => {
        ...
        if (defaultOption.value === "copy-page") {
            ...
            void handleCopyPage();
        } else if (defaultOption.value === "open-claude-code") {
        ...
        <div className="fern-page-actions">
            ...
            >
                <div className="flex items-center gap-2">
                    {showClaudeCodeCopied && defaultOption.value !== "open-claude-code" ? (
                        <>
                            <Check className="size-icon animate-in fade-in duration-200" />
                            <span className="animate-in fade-in duration-200">{t(lang).buttons.copied}</span>
                        </>
                    ) : (
                        <PageActionItem
