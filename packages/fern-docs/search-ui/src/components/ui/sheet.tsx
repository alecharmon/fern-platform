...
>(({ className, ...props }, ref) => (
    <SheetPrimitive.Title
        ref={ref}
        className={cn("text-(color:--grayscale-12) text-lg font-semibold", className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <SheetPrimitive.Description ref={ref} className={cn("text-(color:--accent-12) text-sm", className)} {...props} />
));
