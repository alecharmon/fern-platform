...
const FACET_DISPLAY_MAP: Record<string, Record<string, ReactNode>> = {
    ...
    availability: {
        ...
        ReleaseCandidate: <AvailabilityBadge availability="ReleaseCandidate" rounded variant="subtle" />,
        PublicBeta: <AvailabilityBadge availability="PublicBeta" rounded variant="subtle" />,
        Beta: <AvailabilityBadge availability="Beta" rounded variant="subtle" />,
        PrivateBeta: <AvailabilityBadge availability="PrivateBeta" rounded variant="subtle" />,
        LimitedAvailability: <AvailabilityBadge availability="LimitedAvailability" rounded variant="subtle" />,
        CanaryRelease: <AvailabilityBadge availability="CanaryRelease" rounded variant="subtle" />,
        Preview: <AvailabilityBadge availability="Preview" rounded variant="subtle" />,
        ...
        Experimental: <AvailabilityBadge availability="Experimental" rounded variant="subtle" />,
        Internal: <AvailabilityBadge availability="Internal" rounded variant="subtle" />,
        InDevelopment: <AvailabilityBadge availability="InDevelopment" rounded variant="subtle" />,
        Sunset: <AvailabilityBadge availability="Sunset" rounded variant="subtle" />,
        Deprecated: <AvailabilityBadge availability="Deprecated" rounded variant="subtle" />,
        Retired: <AvailabilityBadge availability="Retired" rounded variant="subtle" />
    }
} as const;
...
const FACET_SMALL_DISPLAY_MAP: Record<string, Record<string, ReactNode>> = {
    ...
    availability: {
        ...
        ReleaseCandidate: <AvailabilityBadge availability="ReleaseCandidate" size="sm" variant="outlined" />,
        PublicBeta: <AvailabilityBadge availability="PublicBeta" size="sm" variant="outlined" />,
        Beta: <AvailabilityBadge availability="Beta" size="sm" variant="outlined" />,
        PrivateBeta: <AvailabilityBadge availability="PrivateBeta" size="sm" variant="outlined" />,
        LimitedAvailability: <AvailabilityBadge availability="LimitedAvailability" size="sm" variant="outlined" />,
        CanaryRelease: <AvailabilityBadge availability="CanaryRelease" size="sm" variant="outlined" />,
        Preview: <AvailabilityBadge availability="Preview" size="sm" variant="outlined" />,
        PreRelease: <AvailabilityBadge availability="PreRelease" size="sm" variant="outlined" />,
        Alpha: <AvailabilityBadge availability="Alpha" size="sm" variant="outlined" />,
        Experimental: <AvailabilityBadge availability="Experimental" size="sm" variant="outlined" />,
        Internal: <AvailabilityBadge availability="Internal" size="sm" variant="outlined" />,
        InDevelopment: <AvailabilityBadge availability="InDevelopment" size="sm" variant="outlined" />,
        Sunset: <AvailabilityBadge availability="Sunset" size="sm" variant="outlined" />,
        Deprecated: <AvailabilityBadge availability="Deprecated" size="sm" variant="outlined" />,
        Retired: <AvailabilityBadge availability="Retired" size="sm" variant="outlined" />
    }
} as const;
