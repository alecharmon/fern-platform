...
import { forwardRef, type MouseEventHandler, type PropsWithChildren, type ReactElement, type ReactNode } from "react";
        ...
        >
            <div
                className={cn("rounded-t-inherit h-10", {
                    "bg-(color:--grayscale-a2)": intent === "none" || intent === "primary",
                    ...
                    {typeof title === "string" ? (
                        <div
                            className={cn("px-1 text-sm", {
                                "text-(color:--grayscale-a11)": intent === "none" || intent === "primary",
