...
export function getMaxHeight(fontSize: "sm" | "base" | "lg", maxLines?: number): number | undefined {
...
export function flattenHighlightLines(highlightLines: HighlightLine[]): number[] {
