        ...
        <div className={cn("fern-audio-player", props.className)}>
            ...
            <div className="relative flex flex-1 flex-col justify-center gap-1">
                <p className="m-0 inline-flex justify-center gap-2 text-center">
                    {props.title != null && (
                        <span className="text-(color:--accent-a11) max-w-[40vw] truncate">{props.title}</span>
                    )}
                    {props.author && (
                        <>
                            <span>&mdash;</span>
                            <span className="text-(color:--grayscale-a11) max-w-[20vw] truncate">{props.author}</span>
                        </>
                    )}
                </p>
                ...
                <div className="mr-1 flex h-full items-center justify-center">
                    <FernButtonGroup className="items-center">
                        ...
                        />
                        <FernButton
                            icon={isPlaying ? <Pause /> : <Play className="fill-(color:--accent-contrast) -mr-0.5" />}
                            variant="filled"
                            intent="primary"
                            rounded
                            size="large"
