...
export const FernLogo = forwardRef<SVGSVGElement, ComponentPropsWithoutRef<"svg"> & { fill?: FernLogoFill }>(
            ...
            >
                <path
                    ...
                    className={cn({
                        ...
                        "fill-fern-ground": fill === FernLogoFill.Ground || fill === FernLogoFill.FernGround,
